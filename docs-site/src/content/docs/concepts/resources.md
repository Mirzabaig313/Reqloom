...
description: "Resources group operations by domain entity. Each operation captures HTTP method, path, body, expected status, and what to extract from the response."
---
