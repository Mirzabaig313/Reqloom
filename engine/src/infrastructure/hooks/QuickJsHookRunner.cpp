...
std::expected<HookOutcome, ChainApiError>
QuickJsHookRunner::runPreRequest(const std::string& /*script*/,
                                  HookContext context) {
    HookOutcome out;
...
std::expected<HookOutcome, ChainApiError>
QuickJsHookRunner::runPostResponse(const std::string& /*script*/,
                                    HookContext context) {
    HookOutcome out;
    out.mutatedRequest = std::move(context.request);
